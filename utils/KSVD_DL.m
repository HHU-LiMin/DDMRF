function Dict = KSVD_DL(...
    TrainingData,...  % a cell containing training data from multiple contrast images.
    param)
...
% =========================================================================
% INPUT ARGUMENTS:
% Data                         a n*N matrix that contins N signals, each of dimension n. 
...
%    iniDictionary             a n*K dictionaries.
